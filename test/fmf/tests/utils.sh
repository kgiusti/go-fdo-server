...
rpm_manufacturer_log_level="info"
...
install_server() {
  ...
  echo "⭐ Creating server home directories"
  setup_home_dirs
}
...
remove_files() {
  ...
  echo "⭐ Removing drop-in files"
  cleanup_drop_ins
  echo "⭐ Removing database files"
  cleanup_databases
  echo "⭐ Removing server home directories"
  cleanup_home_dirs
}
